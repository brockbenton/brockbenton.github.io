...
1. **The Unbanked**: as of 2021, 1.4 billion adults globally lack access to the banking industry (World Bank Global Findex Database (2021)).
2. **Cross-Border Remittance Users**: global average costs have reached 6.49% (World Bank Remittance Prices Worldwide Database (Q1 2024)). 
3. **Agents in Unstable Monetary Systems**: Venezuela peaked at over 1,000,000% inflation, Argentina peaked at 211% inflation, and Lebanon has experienced 98% loss of value.
4. **Micropayment Use Cases**: payments under $1 are economically unviable due to standard fee models.

## The Core of the Demand: Trustlessness

By far one of the most misunderstood concepts of cryptocurrency technology is trustlessness. Rather than trusting a bank to maintain accurate records, not freeze one's account, and so forth, trustlessness represents a shift from trust in *institutions* to trust in *cryptographic math*.
Trustlessness is not saying 'no trust required' but understanding that trust in math is foundationally more stable.
